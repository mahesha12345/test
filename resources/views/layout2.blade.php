        ...
        <div class="as-mainwrapper">
            ...
            <div class="bg-white">
                ...
                <header class="header-two">
                    ...
                    <div class="header-logo-menu padding-small" style="background-color: #E26E67">
                        <div class="container">
                            <div class="row">
                                    ...
                                    <div class="mainmenu-area pull-right">
                                        <div class="mainmenu">
                                            <nav>
                                                <ul id="nav" class="border-full border-top-2">
                                                    <li class="current"><a href="{{URL::to('/admin')}}">Student Request</a> </li>
                                                    <li><a href="{{URL::to('/gallery_upload')}}">Upload images gallery</a> </li> 
                                                     <li><a href="{{URL::to('/admin_gallery_view')}}"> Delete gallery images</a> </li>
                                                  <!--  <li><a href="{{URL::to('/admission_form')}}"> Admission Form</a> </li> -->
                                        ...
                                        <ul class="header-search">
                                            <!-- <li class="search-menu">
                                             ...
                                             <li> <a href="{{URL::to('/admin_login')}}" style="color:#fff;">Log Out</a></li>
                                        </ul>
                                        <!--Search Form-->
                                        <div class="search">
